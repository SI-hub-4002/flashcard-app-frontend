...
export default function CreateFlashcardPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("単語カードの作成に失敗しました");
      }
  ...
  useEffect(() => {
    const fetchFlashcardData = async () => {
      try {
        ...
        setFrontText(result.front_text);
        setBackText(result.back_text);
        ...
        <TabsContent value="preview" className="py-4">
          ...
          <div className="mx-auto max-w-md">
            ...
            <div className="mb-8">
              ...
              <Card className="ml-4 mr-4">
                <CardContent className="flex h-40 md:h-48 flex-col items-center justify-between p-6">
                      ...
                      <SheetContent className="w-full sm:max-w-md overflow-y-auto">
                        ...
                        <div className="prose prose-sm mt-4 text-muted-foreground">
                          {detail ? formatNotes(detail) : (
                            <div dangerouslySetInnerHTML={{ __html: "※未記入時のサンプル<br /><br />例文）<br />&nbsp;&nbsp;&nbsp;I cannot allow such conduct.<br />&nbsp;&nbsp;&nbsp;そのような行為を許すわけにはいかない<br /><br />&nbsp;&nbsp;&nbsp;Customers are not allowed behind the counter<br />&nbsp;&nbsp;&nbsp;お客様はカウンターの後ろには入れません" }} />)}
                        </div>
                      </SheetContent>
                    </Sheet>
                  </div>
